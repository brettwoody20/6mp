...
nonblocking_disk.o: nonblocking_disk.C nonblocking_disk.H simple_disk.H thread.H scheduler.H
...
scheduler.o: scheduler.C scheduler.H thread.H nonblocking_disk.H
...
kernel.bin: start.o utils.o kernel.o \
   ...
   thread.o threads_low.o scheduler.o machine.o machine_low.o simple_disk.o nonblocking_disk.o
